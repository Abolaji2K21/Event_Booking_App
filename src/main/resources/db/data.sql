...
INSERT INTO event(id, event_name,  event_location, date_created, attendees, description, category, organizer_id) VALUES
    (100, 'Summer Picnic', 'Central Park', '2024-06-15', 50, 'Company picnic with foods', 'SOCIAL', 200),
    ...
    (104, 'Tech Meetup', 'Semi_Colon', '2024-05-05', 100, 'Monthly meetup', 'CONFERENCE', 200);
